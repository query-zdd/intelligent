    ...
    (function () {
        ...
        CKEDITOR.skin = {
            path: a, loadPart: function (c, d) {
                ...
                e = e || g && g.bgsize || "16px";
                a && (a = a.replace(/'/g, "\\'"));
                if (x == "insertcustomtitle"){
                    return a && "background-image:url('" + CKEDITOR.getUrl(a) + "');background-size:32px;width:35px" + ";"
                }
                //if (x == "image"){
                //    var urlItem = a.split('/');
                //    urlItem = urlItem.slice(0,urlItem.length-1);
                //    var url = urlItem.join('/') + '/image_custom.png';
                //    return a && "background-image:url('" + url + "') !important;background-size:16px;"
                //}
                else{
