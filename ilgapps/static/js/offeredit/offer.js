        ...
        init: function () {
            ...
            $("#form_sample_2").submit(function () {
                ...
                params.push(
                    ...
                    {name: "offer_name", required: false, type: "text", value: $('#offer_name').val()},
                    {name: "postal_code", required: false, type: "text", value: $('#postal_code').val()},
                    {name: "fax", required: false, type: "text", value: $('#fax').val()},
                    {name: "email", required: false, type: "text", value: $('#email').val()},
                    {name: "mobile_phone", required: false, type: "text", value: $('#mobile_phone').val()},
                    {name: "offer_url", required: false, type: "text", value: $('#offer_url').val()},
                    {name: "mer_resources", required: false, type: "text", value: $('#mer_resources').val()},
                    {name: "address", required: false, type: "text", value: $('#address').val()},
                    {name: "special_details", required: false, type: "text", value: $('#special_details').val()},

                    {name: "offer_sn", required: false, type: "text", value: $('#offer_sn').val()},
                    {name: "up_time", required: false, type: "text", value: $('#up_time').val()},
                    {name: "expired_date", required: false, type: "text", value: $('#expired_date').val()},
                    {name: "keywords", required: false, type: "text", value: $('#keywords').val()},
                     {name: "benefit_name", required: false, type: "text", value: $('#benefit_name').val()},
                     {name: "enjoy_special", required: false, type: "text", value: $('#enjoy_special').val()},
                     {name: "offer_rule", required: false, type: "text", value: $('#offer_rule').val()},
                    ...
                    {name: "coupon_img", required: false, type: "text", value: $('#coupon').val()},
                    {name: "pcc_big", required: false, type: "text", value: $('#pcc_big').val()},
                    {name: "pcc_small", required: false, type: "text", value: $('#pcc_small').val()},
                ...
                $('[name="avail-bank"]:checked').each(function(){
                    avail_array.push($(this).attr('sysuserid'))
                });
                params.push({name: "avail_bank", required: false, type: "text", value: avail_array.join(';')});

                $("#form_sample_2").ajaxSubmit({

                    "url": "/offer/api/saveOffer/",
                    "data": params,
                    "type": 'post',
                    "dataType": 'json',
