...
$("#form_sample").submit(function () {
    ...
    $("#form_sample").ajaxSubmit({
        "url": "/offer/api/fileUploadOfferTc/",
        "data": params,
        "type": 'post',
        "dataType": 'json',
        "beforeSend": function () {
...
$("#form_sample3").submit(function () {
    ...
    $("#form_sample3").ajaxSubmit({
        "url": "/offer/api/fileUploadOfferZipTc/",
        "data": params,
        "type": 'post',
        "dataType": 'json',
        "beforeSend": function () {
...
$("#form_sample1").submit(function () {
    ...
    $("#form_sample1").ajaxSubmit({
        "url": "/offer/api/fileUploadOfferImgTc/",
        "data": params,
        "type": 'post',
        "dataType": 'json',
        "beforeSend": function () {
...
$("#browseZip2").on('change', function () {
    var fullPath = $(this).val();
    var getSuffix = fullPath.split('.');
    if (getSuffix[getSuffix.length - 1] == 'jpg'||getSuffix[getSuffix.length - 1] == 'JPG'||getSuffix[getSuffix.length - 1] == 'png'||getSuffix[getSuffix.length - 1] == 'PNG') {
        var filaName = fullPath.split('\\');
        filaName = filaName[filaName.length - 1];
